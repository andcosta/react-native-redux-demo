...
import { Platform, ScrollView, TouchableWithoutFeedback, View, Image, Text } from 'react-native';
import GlobalStyle from '../../../../../../global/Styles';
import Styles from './index.styles';

export default (ParkingCell = ({ navigation }) => {
  return (
    <ScrollView>
      <TouchableWithoutFeedback onPress={() => navigation.navigate('ParkingDetail')}>
